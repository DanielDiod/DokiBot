...
const smsCont7 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*Sus intis 🪙 se han agotado , Compra mas intis con el comando*`}
const smsCont8 = () => { return ` *ɪɴᴛɪs ᴜsᴀᴅᴏs 🪙*`}
const smsCont9 = () => { return `${global.lenguajeGB['smsAvisoAG']()}*Necesitas el Nivel ➡️*`}
const smsCont10 = () => { return `*Para poder usar el comando tu nivel deber ser el sigue ➡️*`}
const smsCont11 = () => { return `*Actualiza tu nivel con *`}
...
const eGataCoins = () => { return '🪙 ShanaCoins' }
const eGataTickers = () => { return '🎫 Shana Tickers' } 
