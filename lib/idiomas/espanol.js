...
//main.js
const smsWelcome = () => { return '*Hello :V Bienvenid@ al grupo¡!*\n*━━━━━━━━━━━━━━━━*\n\n🌺 *Nombre:* @user\n🍃 *Grupo:* @subject\n\n- *recuerda leer las reglas del grupo* -'}
const smsBye = () => { return '*👋 ¡Adios Hermano Nadien Te Estrañará, xD!*\n*━━━━━━━━━━━━━━━━*\n\n🌺 *Nombre:* @user\n\n*Salúdame a San Predro Hermano*'}
...
const smsJoin1 = (usedPrefix, command) => { return lenguajeYL['smsAvisoMG']() + `🌼 *Ingrese Un Link*\n- *Ejemplo:*\n*${usedPrefix + command}* ${nn}`}

const smsJoin2 = () => { return lenguajeYL['smsAvisoEG']() + `${packname}\n- *Ya Se Ha Unido al Grupo ❤️*`}

const smsJoin = (user) => { return `${packname}\n_🛑 Se Ha Uniso Al Grupo_\n\n- 🍃 *Fue Invitada Por: @${user}*`}
...
smsContacto5, smsContacto6, smsContacto7, smsContacto8, smsMainBot, smsIniJadi2, smsreenvia, smsJBConexionClose2, smsJoin1, smsJoin2, smsJoin}
