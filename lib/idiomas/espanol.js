...
//main.js
const smsWelcome = () => { return '> 🎌 B I E N V E N I D X\n\n*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ*\n\n*Hola usuario @user 👋🏻*\n\n*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ*\n\n*Te doy la bienvenida a @subject*\n\n*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ*\n\n*Recuerda siempre leer la descripción del grupo*'}
const smsBye = () => { return '* B Y E\n*---------------------*\n\n*Espero no vuelvas @user'}
