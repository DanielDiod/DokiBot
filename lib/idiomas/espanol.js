...
const smsGroup = () => { return `Este Comando solo se usa en grupos` }//PARA GRUPOS
...
const smsUnreg = () => { return `*Hey algo no estas registrado\nPara poder usar el bot, es necesario que estes en mi base de datos*` }//VERIFICAR
