...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
 try {
   ...
   await conn.reply(m.chat, '*Esperee..*', m, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '👋 Hola!!', body: [wm, 'Igna •Bot' + lb + ' Igna • Bot 🪙', 'Igna • Bot 🈴'].getRandom(), sourceUrl: [md, nna, yt, nnn, nn, fb, ig].getRandom(), thumbnail: gataImg.getRandom()}}})
