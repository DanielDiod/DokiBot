...
let handler = async (m, { conn, usedPrefix: _p, __dirname }) => {
 try {
   ...
   await conn.reply(m.chat, '*Esperee..*', m, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '👋 Hola!!', body: saludo, sourceUrl: global.yt, thumbnail: imagen6 }}})
