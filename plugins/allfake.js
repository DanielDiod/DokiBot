...
const moji = (await axios.get(`https://raw.githubusercontent.com/Diego-YL-177/YartexBot-MD/main/storage/juegos/emojis.json`)).data
...
global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363263466636910@newsletter', serverMessageId: '', newsletterName: 'IGNA - BOT -MD' }, externalAdReply: { title: wm, body: `👋 Hola ` + nombre, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: imagen1, thumbnail: imagen1, sourceUrl: yt }}}, { quoted: m } //fake con reenviado de canal
}
