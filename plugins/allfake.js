...
global.fake = { contextInfo:{ forwardingScore: 0, externalAdReply: {title: '👋 Hola ' + nombre, body: wm, sourceUrl: nombre, thumbnailUrl: imagen1 }}} //Fake simple

//global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363206717994793@newsletter', serverMessageId: '', newsletterName: 'IGNA BOT FUTURE ' }, externalAdReply: { title: packname, body: saludo, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: imagen1, thumbnail: imagen1, sourceUrl: global.nombre }}}, { quoted: m } //fake con reenviado de canal
}
