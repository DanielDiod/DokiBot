...
let sistema1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Daniel, tu seras Igna-Bot`;
...
const Empireapi1 = await fetch(`https://delirius-api-oficial.vercel.app/api/chatgpt?q=${text}&name=${m.name}&prompt=${syms1}`);
