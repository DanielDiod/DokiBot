...
if (!text) throw `*${lenguajeGB['smsAvisoMG']()}*SOLICITE UNA PETICIÓN PARA USAR EL CHATGPT*\n\n*EJEMPLO DE USO*\n📌 ${usedPrefix + command} Recomienda un top 10 de películas de acción`     
try {
await m.react('💭')  
...
try {
const syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Daniel, tu seras MonkiBot`;
