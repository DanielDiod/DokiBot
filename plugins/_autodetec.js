...
await this.sendMessage(m.chat, { text: `EL GRUPO *${m.messageStubParameters[0] == 'on' ? 'ESTA CERRADO CON EXITO 🔒✅' : 'ESTA ABIERTO CON EXITO 🔓✅'}*\n ${m.messageStubParameters[0] == 'on' ? 'SOLO LOS ADMINS PUEDEN ESCRIBIR👻' : 'YA PUEDEN ESCRIBIR TODOS'} EN ESTE GRUPO`, mentions: [m.sender] }, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})
