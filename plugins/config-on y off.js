...
await conn.reply(m.chat, `*${isEnable ? '🟢' : '🔴'} La función ${type} se a ${isEnable ? 'activado' : 'desactivado'} en ${isAll ? 'este bot*\n\n> By Shana Bot 🈴' : isUser ? '' : 'este chat*\n\n> By Shana Bot 🈴'}`, fkontak, m, fake,)}
