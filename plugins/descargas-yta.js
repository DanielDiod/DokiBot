...
if (!args[0]) throw '*[ ❗𝗘𝗥𝗥𝗢𝗥❗ ]\n\n*Falta el enlace de Youtube para descarga su audio 😴*'
...
await conn.reply(m.chat, `${lenguajeGB['smsAvisoEG']()}*SE ESTA DESCARGANDO SU AUDIO POR FAVOR ESPERA SOY ALGO LENTO...🐢*`, fkontak, m)
try {
let q = '128kbps'
let v = youtubeLink
